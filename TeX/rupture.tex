...
La densité d'énergie interne élastique est $\omega=\dint_0^{\varepsilon_{kl}} \sigma_{ij}\dd\varepsilon_{ij}$. 
...
$ Q_j =\dint_\Gamma \left(\omega n_j- T_k u_{k,j}\right)\dd\Gamma$ pour $j, k=1,2,3$
peuvent s'écrire:
...
$ \Omega = \dint_0^{\sigma_{kl}} \varepsilon_{ij}\dd\sigma_{ij} $
