\chapter{Espaces de Sobolev}\index[aut]{Sobolev (Sergueï Lvovitch), 1908-1989, Russe}
\begin{abstract}
...
$\left( u,v \right)_{m}=\int_{\RR^{n}}\hat{u}\left(\xi \right) \overline{\hat{v}\left(\xi \right)} \left(1 + \xi^{2} \right) ^{m} d\xi$ est un produit hermitien\index[aut]{Hermite (Charles), 1822-1901, Français} équivalent à celui défini plus haut.
...
\begin{equation}
\langle f,g \rangle = \dint_\Omega \left( f(x)\cdot g(x)+\dive  f(x) \dive  g(x) \right) \mathrm dx
\end{equation}
