...
\setlength\largeurBandeauHAL{9.5mm}
...
% demonstration
\newlength\parindentD
\setlength{\parindentD}{\parindent}
\newenvironment{demonstration}[1][Démonstration]{\par\footnotesize\abovedisplayskip=3pt plus1pt minus 1pt\belowdisplayskip=3pt plus1pt minus 1pt\pushQED{\qed}\relax%
\begin{list}{}{%
\labelwidth=-5pt%
\labelsep=5pt%
\leftmargin=25pt%
\rightmargin=25pt}\item[\it#1\@addpunct{.}]\ignorespaces\setlength{\parindent}{\parindentD}}{\end{list}}
...
\newmdtheoremenv[outerlinewidth=0pt,leftmargin=0pt,rightmargin=0pt,backgroundcolor=not,outerlinecolor=black!30,linewidth=0pt,outermargin=0pt,innertopmargin=5pt,innerbottommargin=5pt,innerleftmargin=5pt,innerrightmargin=5pt,skipbelow=.1\baselineskip,skipabove=.5\baselineskip,linecolor=not]{theoreme}{Théorème}
...
\colorlet{def}{ocre!5}
\newmdtheoremenv[outerlinewidth=0pt,leftmargin=0pt,rightmargin=0pt,backgroundcolor=def,outerlinecolor=ocre!30,linewidth=0pt,outermargin=0pt,innertopmargin=5pt,innerbottommargin=5pt,innerleftmargin=5pt,innerrightmargin=5pt,skipbelow=.1\baselineskip,skipabove=.5\baselineskip,linecolor=def]{definition}{Définition}

\theoremstyle{nonumm}
\colorlet{not}{black!5}
%\ifVersionDuDocEstVincent
%\newmdtheoremenv[outerlinewidth=1pt,leftmargin=0pt,rightmargin=0pt,backgroundcolor=not,outerlinecolor=black!30,linewidth=0pt,outermargin=0pt,innertopmargin=5pt,innerbottommargin=5pt,innerleftmargin=25pt,innerrightmargin=5pt,skipbelow=.5\baselineskip,skipabove=.5\baselineskip,linecolor=not]{histoire}{Histoire}%\emph{Histoire}}%{\small Un peu d'histoire}}
%\else
...
%
\font\fntimes=ptmr scaled 10000
\newlength\Chaplengthsup
\newlength\Chaplengthinf
\setlength{\Chaplengthsup}{25mm}
\setlength{\Chaplengthinf}{30mm}%35
%
\newsavebox{\titreChapitre}
\newlength\longTitre
\newlength\hautTitre
\newlength\longReste
%
\newcommand{\ChapPresentation}[1]{%
   \sbox{\titreChapitre}{\rotatebox{45}{\fntimes\thechapter\includegraphics[height=24mm]{bandes.eps}}}
   \setlength{\longTitre}{\wd\titreChapitre}
   \setlength{\hautTitre}{\ht\titreChapitre}
   \setlength{\longReste}{\textwidth}
   \addtolength{\longReste}{-\longTitre}
   \addtolength{\longReste}{-1mm}
   \noindent\parbox[t]{\longTitre}{%\vspace{\Chaplengthsup}
      \unitlength=1mm
      \begin{picture}(0,0)
         \put(-4,0){\raisebox{-\hautTitre}{\usebox{\titreChapitre}}}%\raisebox{-46mm}{\usebox{\titreChapitre}}}
      \end{picture}
   }\hfill%
   \parbox[t]{\longReste}{\vspace{12mm}%\vspace{\Chaplengthsup}
   \flushright\Huge\bfseries#1}\\[\Chaplengthinf]
}
%
\makeatletter
...
\fancyhf{}%
\ifVersionDuDocEstVincent
   \ifVersionDuDocEstPourHAL% (alors bandeau HAL pour Vincent)
...
\DeclareMathOperator{\Ea}{E}
\newcommand\cov[1]{\cova[#1]}
\newcommand\E[1]{\Ea[#1]}
\newcommand\PP[1]{\begin{pmatrix}#1\end{pmatrix}}
%
\ifVersionDuDocEstVincent
   \makeatletter
...
\else
   ...
   \newcommand\MMIT{\@ifstar{\MMIT@star}{\MMIT@nostar}}
   \newcommand\VV@star[1]{\begin{pmatrix}#1\end{pmatrix}}
...
\bigskip\fi}
\newcommand{\parvm}{\ifVersionDuDocEstVincent\par\fi}
...
%
%
% listings avec package listings (au lieu de fancyvrb)
%
\ifVersionDuDocEstVincent
  \definecolor{colorfondansys}{RGB}{255,255,240}% ansys: jaune clair
  \definecolor{colorfondcastem}{RGB}{240,240,255}% castem: bleu clair
  \definecolor{colorfondfortran}{RGB}{240,255,240}% fortran: vert clair
  \definecolor{colorfondfreefem}{gray}{0.95}% freefem: gris clair
  \newcommand{\colororange}{\color{orange!80!black}}
\else
  \definecolor{colorfondansys}{gray}{0.95}% ansys: jaune clair
  \definecolor{colorfondcastem}{gray}{0.95}% castem: bleu clair
  \definecolor{colorfondfortran}{gray}{0.95}% fortran: vert clair
  \definecolor{colorfondfreefem}{gray}{0.95}% freefem: gris clair
   \newcommand{\colororange}{\bfseries}
\fi
%
\lstset{%
  frame=Ltb,
  ...
  xrightmargin=10pt,% pour listings sur 2 colonnes
  framesep=0pt,
  rulesep=0pt,
  backgroundcolor=\color{gray!10},% pour avoir qqch par défaut, mais redéfinit pas les langages utilisés
  rulesepcolor=\colorblack,
  showstringspaces = false,
  basicstyle=\scriptsize\ttfamily,
  stringstyle=\colorgreen\ttfamily,
  commentstyle=\colorblue\rmfamily\itshape,
  identifierstyle=\bfseries,
  keywordstyle=\bfseries\colororange,
  keywordstyle=[2]\bfseries\colormagenta,
  numbers=left,
  numbersep=5pt,
  numberstyle=\colorgreen\scriptsize,
  numberfirstline = false,
  breaklines=trufe,
%  inputencoding=utf8,% marche pas !
%  extendedchars=true,
%  framextopmargin=3pt,
