...
\textcolorblue{vecteur propre}\index{Vecteur propre} $\VV{V}$ non nul tel que $\MM{A}V = \lambda V$, i.e. 
...
\end{array}}
\VVV{\begin{array}{c}
\VV{\overline{q}}_1\\ \VV{\overline{q}}_2
\end{array}}
=
-\VVV{\begin{array}{c}
\VV{\overline{F}}_1\\ \VV{\overline{F}}_2
\end{array}}
\end{equation}
...
d'ortogonalité de $\MM{C}$}: \begin{equation}\LL{\overline{q}}_i\MM{C}\VV{\overline{q}}_i=0\end{equation}
%%%%%%%%%%%%%%%%%%
\medskipvm
...
\begin{equation} y_i = \dint_0^t F_i \mathrm{e}^{-c'_i\omega_i(t-\tau)}\sin \omega_i (t-\tau) d\tau \end{equation}
%%%%%%%%%%%%%%%%%%%%%
\medskipvm
...
On profitera de la rapide dispersion des modes moyennes fréquences dans les milieux dispersifs amortis
...
\begin{equation} \MM{M}=\MMM{\begin{matrix} \MM{A} & \MM{B} \\ \MM{C} & \MM{D} \end{matrix}} \end{equation}
...
\begin{equation} \MM{A} - \MM{B}\cdot \MM{D}^{-1}\cdot \MM{C}\end{equation}
