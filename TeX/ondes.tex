...
que l'on appelle maintenant les valeurs propres\index{valeur propre} associées à l'endomorphisme d'une équation différentielle linéaire.
...
\bigskip
Une <<~deuxième~>> approche consiste à utiliser des \textcolorblue{éléments enrichis}\index{élément enrichi}
...
Dans la EFGM\index{élément finiGM} (Element Free Galerkin Method ou méthode de Galerkine sans maillage),\index{méthode de Galerkine! sans maillage}
