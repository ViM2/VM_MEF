...
%Ce critère est vérifié par une suite lorsque les termes de celle-ci se \og rapprochent uniformément les uns des autres en l'infini\fg.
...
\noindent 2 normes sont équivalentes si elles définissent la même topologie.

\noindent 2 normes $\|.\|_1$ et $\|.\|_2$ sont équivalente s'il existe 2 constantes strictement positives
$k'$ et $k''$ telles que :
...
\medskip
\begin{histoire}
Lorsque l'on demande de citer l'un des grands mathématiciens du XXe siècle,
Henri Poincaré\index[aut]{Poincaré (Henri), 1854-1912, Français}
...
des mathématiques du XXe siècle (et il avait raison; tous ne sont pas résolus à ce jour).\\
\indent
...
Une \textcolorblue{algèbre (de Boole) $\mathcal{E}$} sur un ensemble $X$ est un \textcolorred{ensemble}
non vide de parties de $X$,  stable par passage au complémentaire et par union finie
...
Le couple \textcolorblue{$\left(X,\mathcal{A}\right)$} est appelé \textcolorblue{espace
...
mesurables}.\index{Ensemble mesurable (événement)}
...
La \textcolorblue{mesure de Dirac%\footnotemark
}\index{Mesure!de Dirac}\index[aut]{Dirac (Paul Adrien Maurice), 1902-1984, Anglais}
ou masse de Dirac est une mesure supportée par un singleton
et de masse totale 1.
%\footnotetext{
%\begin{tabular}{c}
%\includegraphics[height=32mm]{Dirac}\\
...
%\medskip
\textcolorblue{La mesure de Lebesgue est finie sur tout compact, chaque compact, qui est borné,
...
%\sbox{\MaBoiteAvecPhotos}{\scriptsize\begin{tabular}{c}\includegraphics[height=\the\HauteurDesPhotos]{metro}\\carte du métro\end{tabular}}
\sbox{\MaBoiteAvecPhotos}{\scriptsize\begin{tabular}{c}\includegraphics[height=\the\HauteurDesPhotos]{metro}\end{tabular}}
\medskip
\ImageAGauche{%
