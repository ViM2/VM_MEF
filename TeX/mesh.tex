...
\begin{itemize}
   ...
   \item Les \textcolorblue{méthodes basées sur un grille} considèrent la surface ou le volume découpé en carrés ou cubes selon une grille prédéfinie. Il suffit alors d'adapter les éléments situés au bord du domaine: ceux-ci seront de moins bonne qualité et parfois même pas totalement conformes au bord théorique.
\end{itemize}
