...
le diamètre maximum des éléments $h$\index{Diamètre d'un EF} et le facteur de forme du maillage\index{Facteur de forme du maillage} 
$\sigma$, ainsi que le diamètre $h_K$ d'un élément $K$\index{Diamètre d'un EF} et sa rondeur $\rho_K$\index{Rondeur d'un EF}.
...
\begin{itemize}
   ...
   \item un \textcolorblue{convexe} $E$ est un ensemble tel que: $\forall (a,b)\in E^2, [a,b]\subset E$;
