...
La réception quant à elle sera liée à la perception, qui elle-même sera décrite de manière normative (niveau, puissance) ou sensorielle (psycho-acoustique...).
...
\end{tabular}
\caption{Passage d'une onde de l'air à l'eau avec et sans amortissement}\label{Fig-AcouDiff6}
\end{figure}
