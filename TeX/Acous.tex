...
\medskip
\subsection{Un petit peu d'amortissement}
...
\end{equation}
Attention, il ne faut pas que le facteur d'amortissement~$d$ soit trop grand... sous peine que l'onde ne se propage pas bien loin. Cela se traduit par:
\colorgris\scriptsize
\begin{Verbatim}[numbers=left,numbersep=3pt,firstnumber=14]
fespace Vh(Th, P2);
Vh<complex> p, q;
...
Pour le plaisir, introduisons un obstacle. Nous proposons le listing (abondamment commenté) suivant:
\colorgris\scriptsize
