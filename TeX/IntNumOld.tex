...
\textbf{Remarques:}
\begin{itemize}
\item \textcolorred{Pour la méthode des éléments finis, l'intégration se déroule sur l'élément de référence, donc on n'a
...
\begin{equation} \int_{-1}^{-1}\int_{-1}^{-1}\int_{-1}^{-1} f(x,y,z)\dd x\dd y\dd z \approx
...
\hline
\multirow{3}{*}{\includegraphics[width=20mm]{trG2.eps}} &
\multirow{3}{*}{3} & 1/2 & 1/2 & \multirow{3}{*}{1/6} & \multirow{3}{*}{2}\\[+2mm]
&&0&1/2&&\\[+2mm]
&&1/2&0&&\\[+2mm]
\hline
\multirow{3}{*}{\includegraphics[height=20mm]{trG3.eps}} &
\multirow{3}{*}{3} & 1/6 & 1/6 & \multirow{3}{*}{1/6} & \multirow{3}{*}{2}\\[+2mm]
&&2/3 & 1/6 &&\\[+2mm]
&&1/6&2/3&&\\[+2mm]
\\
\hline
\multirow{4}{*}{\includegraphics[height=20mm]{trG4.eps}} & 
