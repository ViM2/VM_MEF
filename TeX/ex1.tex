...
\medskip
En correspondance avec les notations du paragraphe~\ref{Sec:Brezzi}, on choisit alors les espaces: \textcolorblue{$H=\{ q\in H(\dive;\Omega); q\cdot n_{|\Gamma}=0\}$} et~$M=L^2(\Omega)$. Le problème est donné, dans la formulation de Brezzi,\index{théorème!de Brezzi}\index[aut]{Brezzi (Franco), 1945-, Italien} par les deux formes bilinéaires
