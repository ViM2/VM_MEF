...
Le siège de Syracuse, les miroirs d'Archimède et sa mort ne font qu'ajouter
à sa légende.
...
ne se fera qu'au \textsc{xix}\fup{e} siècle.
...
de la mécanique classique ou mécanique newtonienne.
...
Cette dernière, initiée dès le \textsc{xviii}\fup{e} siècle, regroupe, en plus de la mécanique
...
\bigskip
\textcolorred{Ce document s'adressant à des personnes connaissant déjà la méthode des éléments finis, nous allons
...
variable. Elle est basée sur le \textcolorblue{principe du travail virtuel}:
\begin{equation}
  \label{Eq:deltaPiTV}
...
l'\textcolorblue{énergie potentielle totale} exprimée en déplacements:
\begin{equation}
  \label{Eq:PiTV}
...
\medskip
La \textcolorblue{fonctionnelle d'Hellinger-Reissner}\index[aut]{Reissner (Max Erich, dit Eric), 1913-1996, Américain}\index[aut]{Hellinger (Ernst David), 1883-1950, Allemand}\index{fonctionnelle!d'Hellinger-Reissner}\index{fonctionnelle!mixte}
...
Elle conduit à la résolution d'un système du type mixte (Brezzi):\index[aut]{Brezzi (Franco), 1945-, Italien}
\begin{equation}
  \label{Eq:SysMixte}
  \MM*{-\MM{A} & \MM{B}\\
   \MM{B}^\TR &\mO}
...
la méthode mixte, celle de \textcolorblue{Pian et Tong}\index[aut]{Pian (Theodore H.H.), 1919-2009, Américain}\index[aut]{Tong (Pin), ? , Chinois}
 est indissociable
de l'adjectif \textcolorblue{hybride},\index{fonctionnelle!hybride} même si, en toute rigueur, elle est
...
manière empirique.
Ce n'est qu'au \textsc{xix}\fup{e} siècle, avec la Tour Eiffel\index[aut]{Eiffel (Gustave), 1832-1923, Français}
...
proportionnel à la force~>>.\colorblack}\index[aut]{Hooke (Robert), 1635-1703, Anglais}
\end{histoire}
