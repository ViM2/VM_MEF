\chapter{Les problèmes non stationnaires}\label{Ch-temps}
\begin{abstract}
...
\begin{itemize}
   \item On retiendra d'abord que cette méthode nécessite moins de mémoire, est donc plus
	rapide et amieux daptée aux \textcolorblue{problèmes de grandes tailles}.
   ...
   \item Enfin, cette méthode est très robuste numériquement et permet de traiter le cas de 
	\textcolorblue{non linéarités couplées}.
\end{itemize}
...
\begin{itemize}
   ...
   \item De plus, cette méthode est bien moins robuste numériquement que la précédente (pivots nuls,
	divergence)...
   \item Enfin et surtout, on se souviendra que c'est une méthode \textcolorblue{coûteuse} en
	mémoire et en temps...
\end{itemize}

\medskip
\begin{figure}[htb]
\centerline{\includegraphics[height=80mm]{Im-Ex-plicite.eps}}
