...
contrairement à l'intuition, \textcolorred{l'augmentation du nombre de points d'interpolation 
...
Mais avant cela, rappelons quelques <<~bases polynomiales~>> connues.%\footnote{%
%\begin{tabular}{ccccc}
...
$\intff{0}{1}$ par:\index{polynôme! de Bernstein}
\begin{equation}
