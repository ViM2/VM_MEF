...
le \textcolorblue{diamètre maximum des éléments, $h$}\index{diamètre d'un élément fini}
...
On note $h_K$ le \textcolorblue{diamètre de l'élément $K$},\index{diamètre d'un élément fini}
 i.e. le maximum des distances (euclidiennes)\index[aut]{Euclide, -325-- -265, Grec}
entre deux points de $K$, et $\rho_K$ la \textcolorblue{rondeur de l'élément $K$},\index{rondeur d'un élément fini}
