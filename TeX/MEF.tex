...
de $a$ et $f$ définies sur $V_h\times V_h$ et $V_h$ respectivement. \textcolorgreen{Dans le pratique, $a_h$ et $f_h$ sont définies sur un espace plus grand que $V_h$, mais pas sur $V$.}
