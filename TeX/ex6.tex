\ifVersionAvecExemplesSepares
   ...
   Dans la mesure où ce document est le support \og théorique\fg{} à un cours
...
et la pratique de codes plus \og industriels \fg.
...
L'analogie avec la \og formulation mathématique\fg{} saute au yeux... et c'est pourquoi cet outil
...
Dans \freefem, nous entrons directement la formulation variationnelle du problème sous forme \og mathématique\fg{}... 
le lien entre pratique des EF et théorie est beaucoup plus clair. 
La boucle de temps est basée sur un schéma de Newmark implicite. Le temps \og courant\fg{}
