\chapter{L'homogénéisation \pln}\label{Ch-Homog}\index{Homogénéisation}
\begin{abstract}
...
\medskip
\ImageADroite{%
Les premières théories remontent au XIXe siècle et sont dues à Mossotti,\index[aut]{Mossotti (Ottaviano-Fabrizio), 1791-1863, Italien} 
...
avec condition de Dirichlet.\index[aut]{Dirichlet (Johann Peter Gustav Lejeune), 1805-1859, Allemand}\index{Conditions aux limites!de Dirichlet} 
...
de deux matériaux différents, mais avec une périodicité, comme illustré à la \fig{Fig-Ax}.
\begin{figure}[htb]
\centerline{\includegraphics[height=35mm]{Ax.eps}}
...
\textcolorblue{le coefficient homogénéisé est $\dfrac1{\langle\frac1A\rangle}$} et non pas $\langle A\rangle$ 
...
\begin{figure}[htb]
\centerline{\includegraphics[height=50mm]{clim.eps}}
...
\medskip
\section{Homogénisation simplifiée pour les matériaux composites}\index{Homogénéisation}

Après ce petit tour \og mathématique \fg{} des méthodes d'homogénéisation,
...
poreux.\index[aut]{Poisson (Siméon Denis), 1781-1840, Français}\index{ED-EDP!de Poisson}\index[aut]{Dirichlet (Johann Peter Gustav Lejeune), 1805-1859, Allemand}\index{Conditions aux limites!de Dirichlet} 
...
soit des conditions de Neumann:\index[aut]{Neumann (Carl Gottfried), 1832-1925, Allemand}\index{Conditions aux limites!de Neumann}
...
\medskip
\textcolorblue{Cherchons des solutions dans le cas où l'on a des conditions de Neumann sur le bords des trous.}\index[aut]{Neumann (Carl Gottfried), 1832-1925, Allemand}\index{Conditions aux limites!de Neumann}
...
\end{array}
\right. \end{equation}
et les conditions de Neumann:\index[aut]{Neumann (Carl Gottfried), 1832-1925, Allemand}\index{Conditions aux limites!de Neumann}
...
la forme de l'ansatz.\index{Ansatz}
...
\og changer (réduire) \fg{} la dimension d'un problème.}
...
ce document, que le fait de connaître les deux aide à mieux cerner à la fois les \textcolorblue{hypothèses}
sur lequelles ces développements sont faits (et que l'on oublie parfois, ayant pour conséquence
des résultats que l'on peut qualifier de surprenants) ainsi que les \textcolorblue{potentialités} qui s'offrent 
à nous.
