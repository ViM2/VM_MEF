...
Nous allons considérer le problème de conductivité linéaire donné par l'équation de Poisson\index[aut]{Poisson (Siméon Denis), 1781-1840, Français}\index{ED-EDP!de Poisson} avec condition de Dirichlet.\index[aut]{Dirichlet (Johann Peter Gustav Lejeune), 1805-1859, Allemand}\index{condition aux limites!de Dirichlet} Nous rappelons qu'il s'agit du problème suivant (c'est aussi l'équation des plaques):
\begin{equation}
\left\{
\begin{aligned}
