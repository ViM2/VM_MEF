...
Sur $\RR$, cela donne: $\|f\|_p=\left(\dint_a^b |f(t)|^pdt\right)^{1/p}$.
...
\begin{equation}(f,g) = \dint_{\Omega} f \bar g \,\mathrm d\mu\end{equation}}\index{Produit scalaire!de $L^2$}
