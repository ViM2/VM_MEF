...
Les recherches des scientifiques russes ont été publiées par V.V.~Bolotin\index[aut]{Bolotin (Vladimir V.), 1926-?, Russe} en 1969 dans \emph{Statistical methods in structural mechanics}.
...
\footnotetext{On distingue les méthodes de:
\begin{itemize}
...
En 1974, Hasofer\index[aut]{Hasofer (A. M.),} et Lind\index[aut]{Lind (Niels Christian),} proposent de passer de l'espace des variables~$X$ à celui de variables normalisées et non corrélées. Ce sont eux qui définissent la définition de l'indice de fiabilité~$\beta_{HL}$ comme la distance minimale de l'origine à la surface d'état limite.
