...
*cfopen,temp,elt
*vwrite,E1(1,1),E1(1,2),E1(1,3),E1(1,4),E1(1,5),E1(1,6),E1(1,7),E1(1,8),E1(1,9)
(9(E13.7,' '))
*cfclose
!
! Resultats
...
\lstset{language={[77]Fortran},backgroundcolor=\color{colorfondfortran}}
\begin{lstlisting}
   PROGRAM VM2
C
...
C
C  But:
C   1. on relit les fichiers de ANSYS generes avec la macro INTERF
...
On utilise la macro en tapant %\verb|*USE,INTERF|, 
\lstinline!*USE,INTERF!, 
et les contraintes sont directement modifiées dans \ansys. On peut alors utiliser les mêmes fonctions qu'habituellement pour visualiser les différentes composantes des contraintes.
