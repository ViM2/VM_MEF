...
\medskip
La \textcolorblue{formulation variationnelle} d'un problème régi par des équations aux dérivées partielles correspond
...
\textcolorgreen{Le but est d'étendre le théorème de Lax-Milgram aux problèmes
...
alors \textcolorred{on revient à un problème de type Lax-Milgram}: trouver~$\mathscr{U}\in H\times M$
