...
\noindent
\textbf{Autre Preuve:}\hskip5pt Une autre voie consiste à étudier directement le problème de minimisation de la fonctionnelle définie par \textcolorblue{$J=\tfrac12 a(v,v)-f(v)$} (ce qui est une façon de montrer le théorème de Riesz) en considérant une suite minimisante et en montrant qu'elle est de Cauchy par l'identité du parallélogramme.~$\square$
\colorblack}
