...
%\medskip
\begin{histoire}%
L'univers mathématiques du début du XVIIIe siècle est dominé par Leonhard Euler\index[aut]{Euler (Leonhard Paul), 1707-1783, Suisse}
...
\medskip
Les différentes techniques mises au point (par exemple pour la résolution des ED, le développement
...
\medskip
\subsection{Espace dual d'un espace vectoriel}\index{espace!dual d'un espace vectoriel}
...
donc l'espace $E$ est isomorphe au sous-espace $f(E)$ de $E^*$.\colorblack

\medskip
\textcolorred{Si l'espace $E$ est de dimension finie $n$, alors l'espace dual $E^*$ est  isomorphe à $E$ et
...
\medskip
\begin{definition}[Dual topologique]\index{espace!dual topologique d'un espace vectoriel}
...
d'EDP linéaires et homogènes du second-ordre dites elliptiques, hyperboliques
et paraboliques.}
