...
\textcolorred{L'isomorphie présente un intérêt majeur, car elle permet de transposer des résultats et propriétés démontrés sur l'un des deux ensembles à l'autre.}
...
On appelle \textcolorblue{espace dual} d'un espace vectoriel~$E$ l'ensemble des formes linéaires sur~$E$. Il est lui-même un~$\KK$-espace vectoriel, et on le note $\mathrm{e}^*$ ou~$hom(E,\KK)$.
\end{definition}
...
Alors l'application~$f: E \to \mathrm{e}^*;\ x \mapsto \varphi_x$ est une application linéaire injective, donc l'espace~$E$ est isomorphe au sous-espace~$f(E)$ de~$\mathrm{e}^*$.\colorblack

\medskip
\textcolorred{Si l'espace~$E$ est de dimension finie~$n$, alors l'espace dual~$\mathrm{e}^*$ est isomorphe à~$E$ et est donc lui aussi de dimension~$n$.}
