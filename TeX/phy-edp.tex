...
\bigskip
\ImageADroite{%
On résoud les équations différentielles par la méthode des séries entières sans s'encombrer des notions
...
\medskip
\begin{histoire}%
Concernant les équations différentiellesP, elles sont initialement résolues par des méthodes ad-hoc, le plus souvent 
géométriques. 
...
\medskip
\ImageADroite{%
La théorie de l'intégration des équations différentiellesP du premier ordre ne date que de 1734. 
...
est analyste, i.e. un spécialiste des équations différentiellesP, un sujet que beaucoup de topologues avaient 
...
\medskip
Les équations de Navier-Stokes sont des équations différentiellesP non linéaires qui décrivent le mouvement 
...
les équations différentiellesP elliptiques conduisent à la notion physique de flux conservatif donné
