...
\medskip
Si l'on sait, dès la fin du \textsc{xvii}\fup{e} siècle intégrer les équations différentielles linéaires du premier et du second ordre 
...
\medskip
Les mathématiciens du \textsc{xviii}\fup{e} siècle admettent sans discussion l'existence de solutions des 
...
\begin{wrapfigure}{r}{108mm}
  \centering
  \subfloat[Matériau composite]{\includegraphics[width=50mm]{mtx-comp2.eps}\label{fig-comp}} \hfill
  \subfloat[Matériau auxétique]{\includegraphics[width=55mm]{mtx_auxetique.eps}\label{fig-aux}}
