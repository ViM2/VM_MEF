...
\else
  ...
  \usepackage{eso-pic}
  \pagestyle{fancy}
  \usepackage{imakeidx} %% pas vraiment utile ici. Problèmes dans l'index pour certaines pages
  \usepackage{idxlayout}
  \makeindex[program=texindy,columns=2,title=Index des concepts,options=-L french -M mystyle.xdy]
  \makeindex[program=texindy,columns=2,name=aut,title=Index des noms propres,options=-L french -M mystyle.xdy]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% lettres et caractères particuliers
% Gauß
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% majuscules droites en typographie française
...
\addcontentsline{toc}{chapter}{\protect\color{ocre} Introduction}
