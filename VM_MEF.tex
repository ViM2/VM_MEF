...
%   \usepackage{etoolbox,ifthen,xifthen}
...
%
   ...
   ~\\[+15cm]\centerline{Version 2b du \today}
   \title
\else
   \thispagestyle{empty}\mbox{}%
   \AddToShipoutPicture*{\includegraphics{Front}}%
